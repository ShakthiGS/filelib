...
<table class="table  table-hover table-dark">
 <thead>
    <tr>
      ...
      <th scope="col">UPLOADER MAIL</th>
     
     <!--  <th scope="col">TEAM</th>
      --> <th scope="col">FILE KEY</th>
      <th scope="col">YOUR EMAIL</th>
        <th scope="col">FOR CONFIRMATION</th>    
    </tr>
  </thead>
       ...
       con=dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `file`.`task` where  staffemail='"+temail+"' and status='Request' ");
...
<%--  <td style="text-align: center;"><%=  rs.getString(6) %></td>
 --%>  <td style="text-align: center;"><%=t6 %></td> 
   ...
   <td><a href="RequestView.jsp?idtask=<%=rs.getString(1)%>&&tlkey=<%=t6%>"><button class="btn btn-primary" onclick="fun();">Confirm</button></a></td>
       </tr> 
	<%} %>
