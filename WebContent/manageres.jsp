...
try {
	...
	PreparedStatement pa=con.prepareStatement("SELECT phash,ahash FROM `file`.`manageract` ");
	...
	st.executeUpdate("UPDATE file.task set status='"+status+"' where idtask='"+id+"' ");
}	 
...
String aphas=secondBlock.hash; 
	...
	ap.setSemail(ad);
		...
		if(m==1){
			...
			response.sendRedirect("error13.jsp");
		}
